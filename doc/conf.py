# -*- coding: utf-8 -*-
#
# pyzufall documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.viewcode', 'sphinxcontrib.issuetracker']

issuetracker = 'github'
issuetracker_project = 'davidak/pyzufall'
